...
pub mod functions {
    ...
    use super::types::*;
     ...
     #[inline] pub unsafe fn DebugMessageCallbackKHR(callback: GLDEBUGPROCKHR, userParam: *const std::os::raw::c_void) -> () { mem::transmute::<_, extern "system" fn(GLDEBUGPROCKHR, *const std::os::raw::c_void) -> ()>(storage::DebugMessageCallbackKHR.ptr)(callback, userParam) }
     ...
     #[inline] pub unsafe fn DebugMessageControlKHR(source: GLenum, type_: GLenum, severity: GLenum, count: GLsizei, ids: *const GLuint, enabled: GLboolean) -> () { mem::transmute::<_, extern "system" fn(GLenum, GLenum, GLenum, GLsizei, *const GLuint, GLboolean) -> ()>(storage::DebugMessageControlKHR.ptr)(source, type_, severity, count, ids, enabled) }
     ...
     #[inline] pub unsafe fn DebugMessageInsertKHR(source: GLenum, type_: GLenum, id: GLuint, severity: GLenum, length: GLsizei, buf: *const GLchar) -> () { mem::transmute::<_, extern "system" fn(GLenum, GLenum, GLuint, GLenum, GLsizei, *const GLchar) -> ()>(storage::DebugMessageInsertKHR.ptr)(source, type_, id, severity, length, buf) }
     ...
     #[inline] pub unsafe fn GetDebugMessageLogKHR(count: GLuint, bufSize: GLsizei, sources: *mut GLenum, types: *mut GLenum, ids: *mut GLuint, severities: *mut GLenum, lengths: *mut GLsizei, messageLog: *mut GLchar) -> GLuint { mem::transmute::<_, extern "system" fn(GLuint, GLsizei, *mut GLenum, *mut GLenum, *mut GLuint, *mut GLenum, *mut GLsizei, *mut GLchar) -> GLuint>(storage::GetDebugMessageLogKHR.ptr)(count, bufSize, sources, types, ids, severities, lengths, messageLog) }
     ...
     #[inline] pub unsafe fn GetObjectLabelKHR(identifier: GLenum, name: GLuint, bufSize: GLsizei, length: *mut GLsizei, label: *mut GLchar) -> () { mem::transmute::<_, extern "system" fn(GLenum, GLuint, GLsizei, *mut GLsizei, *mut GLchar) -> ()>(storage::GetObjectLabelKHR.ptr)(identifier, name, bufSize, length, label) }
     ...
     #[inline] pub unsafe fn GetObjectPtrLabelKHR(ptr: *const std::os::raw::c_void, bufSize: GLsizei, length: *mut GLsizei, label: *mut GLchar) -> () { mem::transmute::<_, extern "system" fn(*const std::os::raw::c_void, GLsizei, *mut GLsizei, *mut GLchar) -> ()>(storage::GetObjectPtrLabelKHR.ptr)(ptr, bufSize, length, label) }
     ...
     #[inline] pub unsafe fn GetPointervKHR(pname: GLenum, params: *mut *mut std::os::raw::c_void) -> () { mem::transmute::<_, extern "system" fn(GLenum, *mut *mut std::os::raw::c_void) -> ()>(storage::GetPointervKHR.ptr)(pname, params) }
     ...
     #[inline] pub unsafe fn ObjectLabelKHR(identifier: GLenum, name: GLuint, length: GLsizei, label: *const GLchar) -> () { mem::transmute::<_, extern "system" fn(GLenum, GLuint, GLsizei, *const GLchar) -> ()>(storage::ObjectLabelKHR.ptr)(identifier, name, length, label) }
     ...
     #[inline] pub unsafe fn ObjectPtrLabelKHR(ptr: *const std::os::raw::c_void, length: GLsizei, label: *const GLchar) -> () { mem::transmute::<_, extern "system" fn(*const std::os::raw::c_void, GLsizei, *const GLchar) -> ()>(storage::ObjectPtrLabelKHR.ptr)(ptr, length, label) }
     ...
     #[inline] pub unsafe fn PopDebugGroupKHR() -> () { mem::transmute::<_, extern "system" fn() -> ()>(storage::PopDebugGroupKHR.ptr)() }
     ...
     #[inline] pub unsafe fn PushDebugGroupKHR(source: GLenum, id: GLuint, length: GLsizei, message: *const GLchar) -> () { mem::transmute::<_, extern "system" fn(GLenum, GLuint, GLsizei, *const GLchar) -> ()>(storage::PushDebugGroupKHR.ptr)(source, id, length, message) }
...
mod storage {
    ...
    use std::os::raw;
     ...
     pub static mut DebugMessageCallbackKHR: FnPtr = FnPtr { ptr: FnPtr::not_initialized as *const raw::c_void, is_loaded: false };
     pub static mut DebugMessageControl: FnPtr = FnPtr { ptr: FnPtr::not_initialized as *const raw::c_void, is_loaded: false };
     pub static mut DebugMessageControlKHR: FnPtr = FnPtr { ptr: FnPtr::not_initialized as *const raw::c_void, is_loaded: false };
     pub static mut DebugMessageInsert: FnPtr = FnPtr { ptr: FnPtr::not_initialized as *const raw::c_void, is_loaded: false };
     pub static mut DebugMessageInsertKHR: FnPtr = FnPtr { ptr: FnPtr::not_initialized as *const raw::c_void, is_loaded: false };
     ...
     pub static mut GetDebugMessageLogKHR: FnPtr = FnPtr { ptr: FnPtr::not_initialized as *const raw::c_void, is_loaded: false };
     ...
     pub static mut GetObjectLabelKHR: FnPtr = FnPtr { ptr: FnPtr::not_initialized as *const raw::c_void, is_loaded: false };
     pub static mut GetObjectPtrLabel: FnPtr = FnPtr { ptr: FnPtr::not_initialized as *const raw::c_void, is_loaded: false };
     pub static mut GetObjectPtrLabelKHR: FnPtr = FnPtr { ptr: FnPtr::not_initialized as *const raw::c_void, is_loaded: false };
     pub static mut GetPointerv: FnPtr = FnPtr { ptr: FnPtr::not_initialized as *const raw::c_void, is_loaded: false };
     pub static mut GetPointervKHR: FnPtr = FnPtr { ptr: FnPtr::not_initialized as *const raw::c_void, is_loaded: false };
     ...
     pub static mut ObjectLabelKHR: FnPtr = FnPtr { ptr: FnPtr::not_initialized as *const raw::c_void, is_loaded: false };
     pub static mut ObjectPtrLabel: FnPtr = FnPtr { ptr: FnPtr::not_initialized as *const raw::c_void, is_loaded: false };
     pub static mut ObjectPtrLabelKHR: FnPtr = FnPtr { ptr: FnPtr::not_initialized as *const raw::c_void, is_loaded: false };
     ...
     pub static mut PopDebugGroupKHR: FnPtr = FnPtr { ptr: FnPtr::not_initialized as *const raw::c_void, is_loaded: false };
     ...
     pub static mut PushDebugGroupKHR: FnPtr = FnPtr { ptr: FnPtr::not_initialized as *const raw::c_void, is_loaded: false };
